      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="max-w-[1634px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="max-w-[708px] hero-text p-6 md:rounded-none rounded-lg backdrop-blur-sm" style={{
            ...
            {/* Main Headline */}
            <motion.h1 
              className="md:mt-[40px] mt-0 text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-8 title tracking-wide"
            ...
            {/* Description Text */}
            <motion.p 
              className="text-white text-m md:text-l font-light leading-relaxed mb-6 max-w-2xl"
