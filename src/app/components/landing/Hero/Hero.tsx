    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex ">
        <div className="max-w-[1634px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="max-w-[680px] hero-text mt-48 p-6 md:rounded-none text-center mx-auto">
            {/* Main Headline */}
            <motion.h1 
              className="md:mt-[40px] mt-0 text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-4 title tracking-wide max-w-[680px]"
